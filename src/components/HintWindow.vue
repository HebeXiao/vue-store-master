<template>
  <el-dialog :visible.sync="visible" width="40%">
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="setHint(1, currentChallengeId)"
        >Level 1 Hint</el-button
      >
      <el-button @click="setHint(2, currentChallengeId)"
        >Level 2 Hint</el-button
      >
      <el-button @click="setHint(3, currentChallengeId)"
        >Level 3 Hint</el-button
      >
    </span>
  </el-dialog>
</template>
...
export default {
  ...
  data() {
    return {
      visible: false,
      hintMessage:
        "Click a button below to receive a hint corresponding to the level of guidance you need.",
      hints: {
        1: {
