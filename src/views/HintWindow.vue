<template>
  <el-dialog
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="setHint(1)">Level 1 Hint</el-button>
      <el-button @click="setHint(2)">Level 2 Hint</el-button>
      <el-button @click="setHint(3)">Level 3 Hint</el-button>
    </span>
  </el-dialog>
</template>
